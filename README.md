...
I decided to use the newest Hardhat version so I can learn and go through new challenges while developing this project, at the same time, I evaluated the differences on using tasks and ignition modules compared to previous hardhat versions and I can say I clearly see an improvement in development times.
